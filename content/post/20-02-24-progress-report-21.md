...
Finally, we've also been accepted by Steam (we'll still keep the game free and accessible outside of Steam) and now have ~~[a new, publicly viewable wiki on HackMD](https://hackmd.io/@ss14/docs)~~ (Note: documentation has since moved to [our own site.](https://docs.playss14.com)).
